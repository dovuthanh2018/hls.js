...
function mergeDetails(oldDetails, newDetails) {
  ...
  if (newDetails.initSegment && oldDetails.initSegment) {
    if (newDetails.initSegments && oldDetails.initSegments) {
      ...
      newDetails.initSegments = _objectSpread(_objectSpread({}, newDetails.initSegments), oldDetails.initSegments);
    }
...
var hlsDefaultConfig = config_objectSpread(config_objectSpread({
  autoStartLoad: true,
